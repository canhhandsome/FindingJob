...
namespace WinFormProject
{
    ...
    {
        public static void DisplayImage(byte[] imageData, ref Guna.UI2.WinForms.Guna2CirclePictureBox ptb)
        {
        ...
        public static void ChoosePicture(ref Guna.UI2.WinForms.Guna2CirclePictureBox ptb)
        {
